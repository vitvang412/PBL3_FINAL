...
namespace DaNangSafeMap.Models.Entities
{
    ...
    public class SecurityAlert
    {
        ...
        [MaxLength(20)]
        public string RoutingDecision { get; set; } = "GREEN";
        ...
        public int DisplayPriority { get; set; } = 50;
        ...
        // ── Kiểm duyệt Admin ──
        /// <summary>Lý do admin nhập khi không duyệt / yêu cầu bổ sung</summary>
        [MaxLength(500)]
        public string? ModerationReason { get; set; }

        /// <summary>Deadline 24h khi admin yêu cầu bổ sung bằng chứng (NEEDS_MORE_INFO)</summary>
        ...
        public ICollection<AlertAppeal> Appeals { get; set; } = new List<AlertAppeal>();
        public ICollection<AlertReport> Reports { get; set; } = new List<AlertReport>();
